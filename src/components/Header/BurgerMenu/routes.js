export const adminRoutes = [
  ...
  { to: '/all-orders', text: 'List of all orders' },
  { to: '/all-reviews', text: 'List of all reviews and questions' },
  { to: '/delete-card', text: 'Deleting/deactivating a card' },
  { to: '/stats', text: 'Statistics of sales, orders' },
];
