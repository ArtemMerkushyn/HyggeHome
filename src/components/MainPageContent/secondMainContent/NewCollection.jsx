...
export const NewCollection = ({catalog, error, isLoading, upperText, lowerText, sliderNeed}) => {
  ...
  return (
    <>
      ...
      {sliderNeed && !isLoading && (
      <CarouselSlider scrollBarPosition={scrollBarPosition} widthScrollNav={widthScrollNav}/>
      )}
